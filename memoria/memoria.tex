...
%	\noindent Algunas personas asocian mayores niveles de eficiencia con paneles de mayor calidad, pero esto no es necesariamente cierto. Alta eficiencia significa que su sistema fotovoltaico solar utilizará menos espacio en su azotea. Por lo tanto, quienes viven en áreas de alta densidad y tienen un espacio muy limitado para la energía solar generalmente están más preocupados por los niveles de eficiencia. \\
	...
	\noindent (Como la opción más conocida es la de Arduino, se presentarán a continuación algunas alternativas a sus placas. Estoy buscando en google:  \textit{alternatives to arduino boards}). \\
	
	\noindent Arduino es la plataforma de microcontroladores elegida por aficionados y educadores. Esto se debe en gran parte al gran apoyo de la comunidad y los recursos disponibles. Sin embargo, esto no significa que no existan más opciones en tanto a microcontroladores. Es importante recordar que un Arduino no es un ordenador, es un microcontrolador diseñado para llevar a cabo una tarea única de manera cíclica, estro es, una vez que lo programas para una tarea, ejecutará esa tarea y sólo esa tarea una y otra vez, dependiendo de cómo haya sido programado.\\
	
	\noindent A continuación, se presentan alternativas a Arduino. Estań dirigidas tanto a aficionados como a desarrolladores y facilitan la programación de microcontroladores. Vale la pena señalar que la mayoría de estas placas tienen variaciones que también vale la pena revisar. \\
	
	\begin{itemize}
		\item NodeMCU
		\item Espressif Systems' ESP8266
		\item STM32
		\item The Pinguino 45K50
		\item Nanode
		\item Teensy 3.6. o Teensy 2.0
		\item Launchpad MSP430
		\item Netduino N3 Wi-Fi
		\item Particle Photon
		\item SparkFun Thing Plus
		\item Adafruit Feather Huzzah
		\item BeagleBoard PocketBeagle
		\item SparkFun RedBoard Artemis
		\item STM32F3 Discovery
		\item Silicon Labs Wonder Gecko
		\item Opción DIY (hacer tú mismo tu propio arduino)
		\item Raspberry Pi Pico
		\item Libelium Waspmote
	\end{itemize}
