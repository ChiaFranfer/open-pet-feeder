...
%	\noindent Algunas personas asocian mayores niveles de eficiencia con paneles de mayor calidad, pero esto no es necesariamente cierto. Alta eficiencia significa que su sistema fotovoltaico solar utilizará menos espacio en su azotea. Por lo tanto, quienes viven en áreas de alta densidad y tienen un espacio muy limitado para la energía solar generalmente están más preocupados por los niveles de eficiencia. \\
	...
	\begin{itemize}
		...
		\item \textbf{Nanode}. Nanode como Arduino ofrece una amplia gama de microcontroladores que puede aprovechar al desarrollar proyectos eléctricos, robots y dispositivos IoT. Viene como un kit de desarrollo, lo que significa que debe estar listo para ensamblar y soldar antes de comenzar con la placa. Las características del Nanode incluyen:
		
		Microcontrolador ATMega328P funcionando a 16MHz
		LED rojos y verdes para un mejor diagnóstico del programa
		Un conector de alimentación mini USB
		Controlador Ethernet ENC28J60 con cristal de 25 MHz y conector Ethernet
		
		El microcontrolador Nanode puede servir como alternativa a Arduino Uno, Mega y Yun. Aunque es una gran alternativa en términos de sus características y capacidades, es bastante caro y su precio de aproximadamente \$ 50 puede establecer algún límite para su uso generalizado entre estudiantes y aficionados. \\
		
		\textit{Especificaciones:} \\
