...
%	\end{figure}
	...
	\begin{itemize}
		...
		\item Existe una solicitud formal de la protectora que va a hacer uso del dispositivo que se cree, Patitas Unidas Los Alcázares [\ref{bib: fb patitas}] [\ref{bib: web patitas}]. Dicha solicitud recoge los mínimos que debe tener en cuenta el proyecto, ya expuestos en el apartado \ref{subsection: objetivos del trabajo}.
	\end{itemize}
