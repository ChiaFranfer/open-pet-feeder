...
//Para poder depurar a través de un puerto serie necesito inicializar uno
void setup() {
  Serial.begin(115200);
  while (!Serial);
  ...
  //Valor alto de Spreading Factor implica muchos datos redundantes, máximo alcance y poca velocidad
